from mysql import puma2, adidas2, anta2, asics2, peak2, Skechers2, new2, nike2
...
def clean_good():
    ...
    # jieba.load_userdict('C:/Users/HZC/Desktop/stopwords-master/userdict.txt')  # 加载自定义词典
    ...
    plt.axis("off")
    plt.show()
    w1.to_file("wordcloud/good/阿迪达斯ADIDAS.jpg")  # 词云图保存路径
    ...
    plt.axis("off")
    plt.show()
    w2.to_file("wordcloud/good/彪马PUMA.jpg")
    ...
    plt.axis("off")
    plt.show()
    w3.to_file("wordcloud/good/NEWBALANCE.jpg")
    ...
    plt.axis("off")
    plt.show()
    w4.to_file("wordcloud/good/安踏ANTA.jpg")
    ...
    plt.axis("off")
    plt.show()
    w5.to_file("wordcloud/good/耐克NIKE.jpg")
    ...
    plt.axis("off")
    plt.show()
    w6.to_file("wordcloud/good/匹克PEAK.jpg")
    ...
    plt.axis("off")
    plt.show()
    w7.to_file("wordcloud/good/斯凯奇Skechers.jpg")
    ...
    plt.axis("off")
    plt.show()
    w8.to_file("wordcloud/good/亚瑟士ASICS.jpg")
