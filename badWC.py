from mysql import puma3, adidas3, anta3, asics3, peak3, Skechers3, new3, nike3
...
def clean_bad():
    ...
    plt.axis("off")
    plt.show()
    w1.to_file("wordcloud/bad/阿迪达斯ADIDAS.jpg")  # 词云图保存路径
    ...
    plt.axis("off")
    plt.show()
    w2.to_file("wordcloud/bad/彪马PUMA.jpg")
    ...
    plt.axis("off")
    plt.show()
    w3.to_file("wordcloud/bad/NEWBALANCE.jpg")
    ...
    plt.axis("off")
    plt.show()
    w4.to_file("wordcloud/bad/安踏ANTA.jpg")
    ...
    plt.axis("off")
    plt.show()
    w5.to_file("wordcloud/bad/耐克NIKE.jpg")
    ...
    plt.axis("off")
    plt.show()
    w6.to_file("wordcloud/bad/匹克PEAK.jpg")
    ...
    plt.axis("off")
    plt.show()
    w7.to_file("wordcloud/bad/斯凯奇Skechers.jpg")
    ...
    plt.axis("off")
    plt.show()
    w8.to_file("wordcloud/bad/亚瑟士ASICS.jpg")
